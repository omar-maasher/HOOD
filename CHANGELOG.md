# [1.16.0](https://github.com/omar-maasher/HOOD/compare/v1.15.9...v1.16.0) (2026-04-09)
...
* add debug logs for Instagram OAuth ([a01d4c7](https://github.com/omar-maasher/HOOD/commit/a01d4c727adceb267fc4e048ba5588ebe1fb3976))
...
* add diagnostics logs to stripe webhooks ([0895e95](https://github.com/omar-maasher/HOOD/commit/0895e953d226823c1474938e61d340bfd796e490))
...
* allow public access to stripe webhooks in middleware ([dd84932](https://github.com/omar-maasher/HOOD/commit/dd84932c74bb36cdbb2c13d22e2421681bb56759))
...
* chat functionality, schema types, date dividers, and bot message sync ([b449ada](https://github.com/omar-maasher/HOOD/commit/b449adad56f9601863d92064cb9c9f84f70ef7ec))
...
* clean up unused icons and restore subscription UI ([6a727b5](https://github.com/omar-maasher/HOOD/commit/6a727b57b3444e75ead3c150a9503ad7c84b355c))
...
* ensure stripe price IDs are used across all environments ([4076a42](https://github.com/omar-maasher/HOOD/commit/4076a42247e078e24e58015f0d21ad9ca099c277))
* finalize subscription page with correct Stripe keys and parameters ([5997d6b](https://github.com/omar-maasher/HOOD/commit/5997d6b899ca21ce84e317707a7e55660c29f634))
...
* **inbox:** manual whatsapp send, bot sync & updates loop ([3ec7bfa](https://github.com/omar-maasher/HOOD/commit/3ec7bfabb76374c00df1c253adec1e7caa305928))
* **inbox:** sync whatsapp bot replies via n8n directly to db ([d5e4aed](https://github.com/omar-maasher/HOOD/commit/d5e4aed58f5eec4fd1e83c61f5b2a0760f70b06d))
* **integrations:** ensure organization exists before connecting and match schema2 ([ec173e3](https://github.com/omar-maasher/HOOD/commit/ec173e32bca19a0f5d675bcca3a11d6c3fbb1fea))
...
* **meta:** add debug logs for Webhook provider matcher ([f1b635d](https://github.com/omar-maasher/HOOD/commit/f1b635da7ba3ba48890914101a764c63a43a3e23))
* **meta:** correct callback logic for direct instagram login ([7521418](https://github.com/omar-maasher/HOOD/commit/75214187e2189fcebcd857ad445bd5f963e4e346))
* **meta:** correct disconnect logic and clean up unused imports ([6d899f6](https://github.com/omar-maasher/HOOD/commit/6d899f6e24591c6ac8a7822551ee1428a9a182e9))
* **meta:** correct Instagram App credentials used for debug_token auto heal ([1b61910](https://github.com/omar-maasher/HOOD/commit/1b6191040ccdecf230c9c7e37a016297f964c161))
* **meta:** correct instagram direct messaging endpoints and token flow ([c2caab2](https://github.com/omar-maasher/HOOD/commit/c2caab270ee11a054ea059e5e336b6ca52fe9eb0))
* **meta:** correct TS compilation in Webhook router for Auto-Heal ([88219ae](https://github.com/omar-maasher/HOOD/commit/88219ae4b2942189bd726f5c887f7c7ac11ba294))
* **meta:** fix callback and comments lint errors ([433c15d](https://github.com/omar-maasher/HOOD/commit/433c15d7d32675f0e841334773ad1f85ff7c07e6))
* **meta:** implement auto-healing for Instagram provider IDs and fix TS ([872366a](https://github.com/omar-maasher/HOOD/commit/872366a46f5a6f38e68509a212f55f4e30eecfaf))
* **meta:** restore original facebook scopes and isolate direct ig flow ([00890c2](https://github.com/omar-maasher/HOOD/commit/00890c259caa928493a80d931f62a91a25fdc9d5))
...
* pick latest integration token to avoid expired ones ([ea6fe16](https://github.com/omar-maasher/HOOD/commit/ea6fe16a88837987091cad728ccfbbca6cc5f61c))
...
* prevent stripe initialization crash in production ([a23e184](https://github.com/omar-maasher/HOOD/commit/a23e184307ce7b16c957f648db3c003ac36b4a1d))
* reduce Instagram scopes to essential 3 (basic, messages, comments) ([88efcc4](https://github.com/omar-maasher/HOOD/commit/88efcc468506b771a32096e54a6656ad7d4ae32b))
* remove unused and import in bookings api to fix build ([37db766](https://github.com/omar-maasher/HOOD/commit/37db766364c822b0700864d24efa47a0898752e9))
* remove unused imports and variables to fix build errors ([d00bbea](https://github.com/omar-maasher/HOOD/commit/d00bbea6708c100006b3742cb47677efa3a37851))
* remove unused imports in subscription page ([1b63682](https://github.com/omar-maasher/HOOD/commit/1b63682fc5623d2bbb16a5bc9e5002ca84a052d5))
* remove unused logger and finalize stripe webhooks ([047e9da](https://github.com/omar-maasher/HOOD/commit/047e9da59b62ed97085ea1158a560341b4ab3099))
* remove unused variables in subscription ([5522c14](https://github.com/omar-maasher/HOOD/commit/5522c14c47f002c60f1c9da59117d3075f34313f))
* resolve 500 error by fixing params handling for next.js 14 ([500c06e](https://github.com/omar-maasher/HOOD/commit/500c06e0be58e592400782c9622c4f3ec62c3957))
...
* restore missing content in subscription page ([5ed3778](https://github.com/omar-maasher/HOOD/commit/5ed3778ad941a49d9b1080a1972fb0b1c021f031))
* restore subscription UI step 1 ([882f20b](https://github.com/omar-maasher/HOOD/commit/882f20b90c5087d635fd7f178898f9e33c9cb47c))
...
* simplify subscription page to isolate 500 error ([22dce29](https://github.com/omar-maasher/HOOD/commit/22dce294255e2b4be42a6ec9421faa6ad425abaf))
...
* **webhooks:** resolve instagram comments routing issue ([3dd608b](https://github.com/omar-maasher/HOOD/commit/3dd608bd92d7f7d64dde485a269f3093e7cc7c93))
...
* complete omnichannel inbox for WhatsApp, Instagram, and Messenger ([2ba351d](https://github.com/omar-maasher/HOOD/commit/2ba351d7d60ada9d580a7ad0bb5215794c6c56d7))
...
* dual Instagram connect options (direct + Facebook flow) ([e7ca9ca](https://github.com/omar-maasher/HOOD/commit/e7ca9ca27774945f3146b6cb02b0ab38a79b475e))
...
* implement n8n ai web discovery engine and eslint fixes ([73b3925](https://github.com/omar-maasher/HOOD/commit/73b39256f172fc0529194809ff203030066c6812))
* implement real-time polling for inbox messages and conversations ([ad41b2d](https://github.com/omar-maasher/HOOD/commit/ad41b2d32e16e2efc31e070a5b2816077429b2d1))
...
* improve n8n error handling and linting fixes ([3712900](https://github.com/omar-maasher/HOOD/commit/3712900caa7da035d03cb5cec57c79d4a8561860))
...
* **integrations:** use meta embedded signup with custom app_id and config_id ([0ba7ebc](https://github.com/omar-maasher/HOOD/commit/0ba7ebc77bfcbbc16c04df9ee69caa21338a2835))
...
* **meta:** add pages_manage_metadata scope for better page visibility ([29d9efd](https://github.com/omar-maasher/HOOD/commit/29d9efd1ca73ad4dd9ded88ef36bda21591fbec9))
* **meta:** support direct instagram business login ([c806afb](https://github.com/omar-maasher/HOOD/commit/c806afb8c52cde55d9223d72a5bc0641b3ac7c7c))
* migrate Instagram to direct Business Login OAuth flow ([bff4d54](https://github.com/omar-maasher/HOOD/commit/bff4d545a0eeb6199614014d6e94cf3309e1682c))
...
* premium rebranding, theme-aware inbox and business settings, onboarding persistence fix, and dashboard header cleanup ([63565aa](https://github.com/omar-maasher/HOOD/commit/63565aa22a0a9e4c5804eacdd3c2bf92d0c6a6e2))
...
* update plans to paid model with new prices (35 and 50) ([aec3087](https://github.com/omar-maasher/HOOD/commit/aec3087530ea646076145d2c9beb280b0d9e7eda))
* upgrade inbox layout like respond.io and add stripe prep ([db6c0f1](https://github.com/omar-maasher/HOOD/commit/db6c0f198642403d0baafd3c239077b924d28a16))
...
* إضافة صفحة إدارة التعليقات وتفعيل توجيهها لـ N8N ([51ffab0](https://github.com/omar-maasher/HOOD/commit/51ffab059117c9416cb59e786574419776bb4833))

# [1.16.0](https://github.com/omar-maasher/HOOD/compare/v1.15.9...v1.16.0) (2026-04-08)
...
# [1.16.0](https://github.com/omar-maasher/HOOD/compare/v1.15.9...v1.16.0) (2026-04-07)
...
# [1.16.0](https://github.com/omar-maasher/HOOD/compare/v1.15.9...v1.16.0) (2026-03-31)
...
# [1.16.0](https://github.com/omar-maasher/HOOD/compare/v1.15.9...v1.16.0) (2026-03-30)
...
# [1.16.0](https://github.com/omar-maasher/HOOD/compare/v1.15.9...v1.16.0) (2026-03-29)
...
# [1.16.0](https://github.com/omar-maasher/HOOD/compare/v1.15.9...v1.16.0) (2026-03-28)
...
# [1.16.0](https://github.com/omar-maasher/HOOD/compare/v1.15.9...v1.16.0) (2026-03-27)
...
# [1.16.0](https://github.com/omar-maasher/HOOD/compare/v1.15.9...v1.16.0) (2026-03-24)
